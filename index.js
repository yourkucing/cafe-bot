...
client.on('messageReactionAdd', async (reaction, user) => {
 ...
 client.on('messageCreate', msg => {
    ...
    if (msg.guild.id == "979221828876791839") {
        ...
        entrancehallID = "979969811784290345"
        ...
        if (msg.channel.id == thestudyID) {
            if (message != "the killer is... miss crane") {
                if(message.includes("the killer is...")) {
                    ...
                    else if (message == "the killer is... professor cuckoo") {
                    ...
                    else if (message == "the killer is... ms. gannet" || message == "the killer is... ms gannet") {
                    ...
                    else if (message == "the killer is... mrs. wren" || message == "the killer is... mrs wren") {
                    ...
                    else if (message == "the killer is... mr. penguin" || message == "the killer is... mr penguin") {
                    ...
                    else if (message == "the killer is... mr. jay" || message == "the killer is... mr jay") {
                    ...
                    else if (message == "the killer is... mr. falcon" || message == "the killer is... mr falcon") {
                    ...
                    else if (message == "the killer is... miss mallard") {
                    ...
                    else if (message == "the killer is... lord cuckoo") {
                    ...
                    else if (message == "the killer is... lady cuckoo") {
                    ...
                    else if (message == "the killer is... colonel kestral") {
                    ...
                    sleep(60).then(r => {
                        ...
                        .then(fs => {
                            msg.member.roles.add("979263010461855774").then(f => {
